...
$$f(response;\alpha_*, \gamma_*, \mu_*, \phi_*)
  \begin{cases}
        \alpha_*(1-\gamma_*) & \text{if  y = 0} \\
        \alpha_*\gamma_* & \text{if  y = 1} \\
        (1-\alpha_*)f(response;\mu_*,\phi_*) & \text{if  y } \in \text{(0,1)} \\
  \end{cases}$$

Where $ 0 <\alpha, \gamma, \mu < 1 ,\;\; \phi > 0, \;\; f(response;\mu_*,\phi_*)~ Beta(p_*= \mu_*\phi_*, q_*= \phi_*(1-\mu_*)) $
